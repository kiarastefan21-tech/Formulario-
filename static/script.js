...
document.getElementById("pipeQuestions").innerHTML = `
    ...
    <h5>3. Marca</h5> 
       <textarea name="marca_pipe"></textarea>
    <br><br> 

    <h5>4. Fecha de Instalación: DD/MM/AA</h5> 
    <textarea name="fecha_pipe"></textarea>
    <br><br>

    <h5>5. Estado</h5>
        <select name="estado_pipe">
            <option value=""></option>
            <option value="Bueno">Bueno</option>
            <option value="Regular">Regular</option>
            <option value="Malo">Malo</option>
...
<select name="disp${numero}_productos">
    <option value=""></option>
